...
export const DesktopNav = ({ navItems }: { navItems: NavItem[] }) => {
  ...
  return (
    <div className="flex flex-row space-x-6 items-center antialiased border px-6 py-3 rounded-2xl bg-gray-100 w-fit max-w-5xl mx-auto">
      ...
      {navItems.map((navItem, idx) => (
        <CustomLink
          key={`link=${idx}`}
          href={navItem.link}
          className="text-gray-700 text-base relative hover:text-white transition-colors whitespace-nowrap"
      ...
      <div className="flex items-center space-x-4 ml-4">
        <a
          href="tel:0695918103"
          className="text-primary hover:text-secondary transition-colors p-2 rounded-full hover:bg-primary/10"
          title="Appelez-nous"
        >
